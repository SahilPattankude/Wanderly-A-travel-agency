...
export const stays: StayOrActivity[] = [
  ...
  },
  {
    ...
    location: "Mumbai, India",
    image: "https://images.unsplash.com/photo-1590050752117-238cb0612b1b?q=80&w=1000&auto=format&fit=crop",
    price: 1500,
    rating: 4.6,
    reviews: 1205,
    type: "Activity",
  ...
  },
  {
    ...
    location: "Pune, India",
    image: "https://images.unsplash.com/photo-1626761191244-893997d2085a?q=80&w=1000&auto=format&fit=crop",
    price: 1000,
    rating: 4.7,
    reviews: 580,
    type: "Activity",
  ...
  },
  {
    ...
    location: "Delhi, India",
    image: "https://images.unsplash.com/photo-1585135497273-1a86b09fe70e?q=80&w=1000&auto=format&fit=crop",
    price: 1500,
    rating: 4.8,
    reviews: 2450,
    type: "Activity",
  ...
  },
  {
    ...
    location: "Hyderabad, India",
    image: "https://images.unsplash.com/photo-1608958415217-024823d0473b?q=80&w=1000&auto=format&fit=crop",
    price: 1200,
    rating: 4.7,
    reviews: 1100,
    type: "Activity",
...
export const defaultItineraries: Record<string, DefaultItineraryItem[]> = {
  santorini: [
    { id: "santo-1", day: 1, time: "09:00", title: "Arrive & check in", place: "Azure Cliff Resort, Santorini" },
    { id: "santo-2", day: 1, time: "13:00", title: "Walk the caldera path", place: "Fira to Oia" },
    { id: "santo-3", day: 1, time: "18:30", title: "Sunset sailing trip", place: "Ammoudi Bay" },
    { id: "santo-4", day: 2, time: "10:00", title: "Wine tasting tour", place: "Santo Wines Winery" },
  ],
  kyoto: [
    { id: "kyo-1", day: 1, time: "10:00", title: "Check in & green tea welcome", place: "Gion Machiya House, Kyoto" },
    { id: "kyo-2", day: 1, time: "13:30", title: "Explore Kiyomizu-dera Temple", place: "Higashiyama District" },
    { id: "kyo-3", day: 1, time: "19:00", title: "Kaiseki multi-course dinner", place: "Gion neighborhood" },
    { id: "kyo-4", day: 2, time: "09:30", title: "Arashiyama Bamboo Forest walk", place: "Arashiyama, Kyoto" },
  ],
  bali: [
    { id: "bal-1", day: 1, time: "12:00", title: "Villa check-in & relax", place: "Ubud Canopy Villas, Bali" },
    { id: "bal-2", day: 1, time: "15:30", title: "Campuhan Ridge Walk", place: "Ubud" },
    { id: "bal-3", day: 2, time: "08:30", title: "Tegallalang Rice Terrace tour", place: "Ubud" },
    { id: "bal-4", day: 2, time: "16:00", title: "Yoga & meditation session", place: "Yoga Barn Ubud" },
  ],
  banff: [
    { id: "bnf-1", day: 1, time: "11:00", title: "Arrive in Banff & check-in", place: "Banff Springs Hotel" },
    { id: "bnf-2", day: 1, time: "14:00", title: "Canoeing on Moraine Lake", place: "Moraine Lake, Banff" },
    { id: "bnf-3", day: 2, time: "09:00", title: "Johnston Canyon hike", place: "Johnston Canyon Trail" },
    { id: "bnf-4", day: 2, time: "16:35", title: "Relax at Upper Hot Springs", place: "Banff Upper Hot Springs" },
  ],
  marrakech: [
    { id: "mar-1", day: 1, time: "13:00", title: "Riad check-in & mint tea", place: "Riad Kheirredine, Marrakech" },
    { id: "mar-2", day: 1, time: "16:00", title: "Jemaa el-Fnaa square stroll", place: "Medina of Marrakech" },
    { id: "mar-3", day: 2, time: "10:00", title: "Majorelle Garden & YSL Museum", place: "Rue Yves Saint Laurent" },
    { id: "mar-4", day: 2, time: "14:30", title: "Souks shopping experience", place: "Medina Souks" },
  ],
  patagonia: [
    { id: "pat-1", day: 1, time: "10:30", title: "Arrive at eco-lodge", place: "Patagonia Eco Camp" },
    { id: "pat-2", day: 1, time: "13:00", title: "Perito Moreno glacier walk", place: "Los Glaciares National Park" },
    { id: "pat-3", day: 2, time: "08:00", title: "Mount Fitz Roy day trek", place: "El Chaltén trailhead" },
  ],
  mumbai: [
    { id: "mum-1", day: 1, time: "09:00", title: "Taj Mahal Palace Check-in", place: "Colaba, Mumbai" },
    { id: "mum-2", day: 1, time: "14:00", title: "Gateway of India & Marine Drive", place: "South Mumbai" },
    { id: "mum-3", day: 2, time: "10:00", title: "Elephanta Caves Tour", place: "Mumbai Harbour" },
    { id: "mum-4", day: 2, time: "17:00", title: "Street Food Tour at Chowpatty", place: "Chowpatty Beach" },
  ],
  pune: [
    { id: "pun-1", day: 1, time: "10:00", title: "JW Marriott Pune Check-in", place: "Senapati Bapat Road, Pune" },
    { id: "pun-2", day: 1, time: "14:30", title: "Shaniwar Wada Heritage Walk", place: "Pune City Center" },
    { id: "pun-3", day: 2, time: "09:00", title: "Sinhagad Fort Sunrise Trek", place: "Sinhagad Fort Trail" },
    { id: "pun-4", day: 2, time: "16:00", title: "Aga Khan Palace Heritage Tour", place: "Yerwada, Pune" },
  ],
  delhi: [
    { id: "del-1", day: 1, time: "11:00", title: "Leela Palace Delhi Check-in", place: "Chanakyapuri, New Delhi" },
    { id: "del-2", day: 1, time: "14:00", title: "Red Fort & Jama Masjid Tour", place: "Old Delhi" },
    { id: "del-3", day: 2, time: "09:30", title: "Humayun's Tomb Heritage Walk", place: "Nizamuddin East, Delhi" },
    { id: "del-4", day: 2, time: "16:30", title: "Old Delhi Street Food Walk", place: "Chandni Chowk" },
  ],
  hyderabad: [
    { id: "hyd-1", day: 1, time: "12:00", title: "Taj Falaknuma Palace Check-in", place: "Falaknuma, Hyderabad" },
    { id: "hyd-2", day: 1, time: "15:30", title: "Charminar & Laad Bazaar Walk", place: "Old City, Hyderabad" },
    { id: "hyd-3", day: 2, time: "09:30", title: "Golconda Fort Guided Tour", place: "Golconda, Hyderabad" },
    { id: "hyd-4", day: 2, time: "19:00", title: "Hyderabadi Biryani Tasting", place: "Hyderabad" },
  ],
  bengaluru: [
    { id: "blr-1", day: 1, time: "11:30", title: "Leela Palace Bengaluru Check-in", place: "HAL Airport Road, Bengaluru" },
    { id: "blr-2", day: 1, time: "15:00", title: "Cubbon Park & Traditional Breakfast", place: "Cubbon Park, Bengaluru" },
    { id: "blr-3", day: 2, time: "10:00", title: "Bangalore Palace Heritage Tour", place: "Vasanth Nagar" },
    { id: "blr-4", day: 2, time: "18:00", title: "Nandi Hills Sunrise Excursion", place: "Nandi Hills" },
  ],
};
...
export const destinationSuggestions: Record<string, DefaultSuggestionItem[]> = {
  santorini: [
    { id: "santo-s1", time: "08:00", title: "Beach morning", place: "Red Beach, Akrotiri" },
    { id: "santo-s2", time: "16:00", title: "Museum visit", place: "Museum of Prehistoric Thera" },
  ],
  kyoto: [
    { id: "kyo-s1", time: "08:00", title: "Golden Pavilion tour", place: "Kinkaku-ji Temple" },
    { id: "kyo-s2", time: "17:00", title: "Fushimi Inari Shrine walk", place: "Fushimi Inari Gates" },
  ],
  bali: [
    { id: "bal-s1", time: "06:00", title: "Mount Batur sunrise trek", place: "Kintamani" },
    { id: "bal-s2", time: "17:30", title: "Uluwatu Temple sunset & Kecak dance", place: "Uluwatu" },
  ],
  banff: [
    { id: "bnf-s1", time: "08:30", title: "Banff Gondola ride", place: "Sulphur Mountain" },
    { id: "bnf-s2", time: "12:00", title: "Lake Louise tea house hike", place: "Lake Louise" },
  ],
  marrakech: [
    { id: "mar-s1", time: "06:00", title: "Hot air balloon flight", place: "Marrakech Outskirts" },
    { id: "mar-s2", time: "18:00", title: "Hammam spa ritual", place: "Les Bains de Marrakech" },
  ],
  patagonia: [
    { id: "pat-s1", time: "07:30", title: "Torres del Paine viewpoint hike", place: "Torres del Paine National Park" },
    { id: "pat-s2", time: "11:00", title: "Boat navigation to Grey Glacier", place: "Lake Grey" },
  ],
  mumbai: [
    { id: "mum-s1", time: "08:00", title: "Marine Drive Morning Jog", place: "Marine Drive" },
    { id: "mum-s2", time: "16:00", title: "Sanjay Gandhi National Park Walk", place: "Borivali" },
  ],
  pune: [
    { id: "pun-s1", time: "08:00", title: "Osho Garden Morning Meditation", place: "Koregaon Park" },
    { id: "pun-s2", time: "17:00", title: "Saras Baug Lake Visit", place: "Pune" },
  ],
  delhi: [
    { id: "del-s1", time: "08:00", title: "Lodhi Gardens Heritage Walk", place: "Lodhi Road" },
    { id: "del-s2", time: "17:00", title: "India Gate Evening Stroll", place: "Rajpath" },
  ],
  hyderabad: [
    { id: "hyd-s1", time: "08:00", title: "Hussain Sagar Morning Cruise", place: "Hyderabad" },
    { id: "hyd-s2", time: "17:00", title: "Qutb Shahi Tombs Heritage Walk", place: "Ibrahim Bagh" },
  ],
  bengaluru: [
    { id: "blr-s1", time: "07:30", title: "Lalbagh Botanical Garden Hike", place: "Lalbagh" },
    { id: "blr-s2", time: "17:00", title: "Commercial Street Shopping", place: "Tasker Town" },
  ],
};
